    ...
    <div className="h-[calc(100vh-80px)] overflow-hidden">
      ...
      <div className="absolute m-auto left-1/2 bottom-8 flex gap-4">
        {slides.map((slide, index) => (
          <div
            className={`w-3 h-3 rounded-full ring-1 ring-violet-600 cursor-pointer flex items-center justify-center ${
          ...
          >
            {current === index && (
              <div className="w-[6px] h-[6px] bg-violet-600 rounded-full"></div>
            )}
          </div>
        ))}
      </div>
